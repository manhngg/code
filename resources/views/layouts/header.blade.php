...
<div class="glass-header-top" style="display: none">
...
<em><a class="selfservice-link-login" href="/vn/myaccount/login/login_success.php" title="Tài Khoản Của Tôi ">Chào mừng trở lại 
<span class="login-icon"></span></a></em>
</div>

<div id="logo"><a href="/"><img src="images/img/logo.png" style="float: left; position: absolute; margin-left: 30px;margin-top: -13px;height: 130%;width: 11%;"></a></div>
<img src="images/img/header-shadow-img.png" style="vertical-align: middle;width: 100%; max-height: 30px;" >
<!-- ---------------------------------------------------------------------------------------------------------------------------- -->
<div class="menu">
<ul>
<li class="dropdown">
  <a href="/products" class="dropbtn" class="label">NAM</a>
  ...
  <div class="dropdown-content">
      <div class="col-container">
          ...
          <div class="col"> <!-- cột 1 menu 4 -->
            ...
            <a href="/vn/?running"><img src="images/img/Running.png"></a>
            <br>
          ...
          <div class="col"> <!-- cột 2 menu 1 -->
            ...
            <a href="/vn/?soccer"><img src="images/img/FB_SS18_DeadlyStrike_Predator_NV-IMG.jpg"></a>
            <br>
          ...
          <div class="col"> <!-- cột 3 menu 1 -->
            ...
            <a href="/vn/?basketball"><img src="images/img/new_harden_basketball_flyout_nav.jpg" height="80" width="172"></a>
            <br>
          ...
          <div class="col"> <!-- cột 4 menu 1 -->
            ...
            <a href="/vn/?football"><img src="images/img/CLP_nav_1.jpg"></a>
            <br>
  ...
  <div class="dropdown-content">
      <div class="col-container">
          ...
          <div class="col"> <!-- cột 1 menu 5 -->
            <a href="/vn/?originals"><img src="images/img/text_originals.png"></a>
            <br>
            <a href="/vn/?originals"><img src="images/img/D1_websine_nav_172x80.jpg"></a>
            <br>
          ...
          <div class="col"> <!-- cột 2 menu 5 -->
            <a href="/vn/?athletics-zne"><img src="images/img/adidas-logo-menu-2.jpg"></a>
            <br>
            <a href="/vn/?athletics-zne"><img src="images/img/Athletics_Flyout_US.jpg"></a>
            <br>
          ...
          <div class="col"> <!-- cột 3 menu 5 -->
            <a href="/vn/?adidas_by_stella_mccartney"><img src="images/img/SM.png"></a>
            <br>
            <a href="/vn/?adidas_by_stella_mccartney"><img src="images/img/aSMC_SS18_Run_SUP_03_Flyout_Nav_172x80.jpg"></a>
            <br>
...
<li class="menu-spacer___1eBnZ"></li>
<li class="dropdown">
  <a href="/vn/?customizable" class="dropbtn">KÌ NGHỈ</a>
  <div class="dropdown-content">
      <div class="col-container">
          <!-- \\\\//// -->
          <!-- COLUMN 1 -->
          ...
          <div class="col"> <!-- cột 1 menu 6 -->
            ...
            <a href="/vn/?originals-customizable"><img src="images/img/mi_1.jpg"></a>
            <br>
          ...
          <div class="col"> <!-- cột 2 menu 6 -->
            ...
            <a href="/vn/?running-customizable"><img src="images/img/ss18_miultraboost_multicolor_Topnav.jpg"></a>
            <br>
          ...
          <div class="col"> <!-- cột 3 menu 6 -->
            ...
            <a href="/vn/?basketball-customizable"><img src="images/img/mi_3.jpg"></a>
            <br>
          ...
          <div class="col"> <!-- cột 4 menu 6 -->
            ...
            <a href="#"><img src="images/img/mi_2.jpg"></a>
            <br>
...
<a title="Kiểm tra" href="<?php if(empty ($_SESSION["email"])) echo '/vn/myaccount/login/'; else echo '/vn/cart';?>" class="addtobag"><img src="images/img/bag.png" style="float: right"></a>
...
<div class="wish" <?php if(empty ($total_records)) echo ' style="display: none"';?>>
  ...
  <img src="images/img/wish.png" style="float: right">
  <div class="centered">
